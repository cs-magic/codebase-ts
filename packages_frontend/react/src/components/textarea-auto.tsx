  ...
  return (
    <ReactTextareaAutoSize
      ...
      onKeyDown={(event) => {
        ...
        if (onQuery) {
          if (event.key === "Enter" && !event.nativeEvent.isComposing && !event.shiftKey && !event.altKey) {
...
export const TextareaAuto = forwardRef<
  ...
  ComponentProps<typeof TextareaInner> & { atom?: Atom<string> }
>(({ atom, ...props }, ref) => {
  return !atom ? <TextareaInner ref={ref} {...props} /> : <TextareaWithAtom ref={ref} atom={atom} {...props} />
})
