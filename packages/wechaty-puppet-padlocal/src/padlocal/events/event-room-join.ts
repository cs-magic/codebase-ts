...
import { createSysmsgTemplateRunner, SysmsgTemplateLinkProfile } from "../messages/sysmsg/message-sysmsgtemplate.js";
import { executeRunners } from "../utils/runner.js";

const YOU_INVITE_OTHER_REGEX_LIST = [/^你邀请"(.+)"加入了群聊 {2}\$revoke\$/, /^You invited (.+) to the group chat/];
