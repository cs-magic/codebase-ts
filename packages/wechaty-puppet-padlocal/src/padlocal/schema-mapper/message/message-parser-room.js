...
async function roomMessageSentByOthers(padLocalMessage, ret) {
...
async function roomMessageSentBySelf(padLocalMessage, ret) {
 ...
 */
//@ts-ignore
export const roomParser = async (padLocalMessage, ret, context) => {
