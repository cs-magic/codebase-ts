...
// @ts-ignore
export const appMsgParser = async (webMessageRawPayload, ret, context) => {
    ...
    try {
        ...
        log.warn(LOGPRE, `Error occurred while parse message attachment: ${JSON.stringify(webMessageRawPayload)} , ${e.stack}`);
    }
    return ret;
};
