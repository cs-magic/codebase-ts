...
export class PuppetWechat4u extends PUPPET.Puppet {
    ...
    async contactList() {
        ...
        const idList = Object.keys(this.wechat4u.contacts).filter((contact) => !this.wechat4u.Contact.isRoomContact(this.wechat4u.contacts[contact]));
        return idList;
    }
    ...
    async messageFile(id) {
        ...
        switch (payload.type) {
            ...
            case PUPPET.types.Message.Audio: {
                 ...
                 * 语音消息
                 */
                const audioFileBox = FileBox.fromBuffer((await this.wechat4u.getVoice(rawPayload.MsgId)).data, `message-${id}-audio.sil`);
            ...
            case PUPPET.types.Message.Attachment:
                if (rawPayload.AppMsgType === 6) {
                    ...
                    return FileBox.fromBuffer((await this.wechat4u.getDoc(rawPayload.FromUserName, rawPayload.MediaId, rawPayload.FileName)).data, filename);
                }
                break;
            default:
                break;
