...
const getNumberEnv =
  (env: typeof process.env) => (varName: string, defaultValue: number) => {
...
const WECHATY_PUPPET_LRU_CACHE_SIZE_POST = (v?: number) =>
  v ??
  getNumber("WECHATY_PUPPET_LRU_CACHE_SIZE_POST", DEFAULT_LRU_CACHE_SIZE_POST)
const WECHATY_PUPPET_LRU_CACHE_SIZE_ROOM = (v?: number) =>
  v ??
  getNumber("WECHATY_PUPPET_LRU_CACHE_SIZE_ROOM", DEFAULT_LRU_CACHE_SIZE_ROOM)
