...
declare const roomInvitationMixin: <MixinBase extends typeof PuppetSkeleton & (abstract new (...args: any[]) => {
     ...
     * @protected
     */
    roomInvitationPayloadCache(roomInvitationId: string): undefined | RoomInvitationPayload;
...
type ProtectedPropertyRoomInvitationMixin = 'roomInvitationPayloadCache' | 'roomInvitationRawPayload' | 'roomInvitationRawPayloadParser';
