...
declare const serviceMixin: <MixinBase extends typeof PuppetSkeleton>(mixinBase: MixinBase) => ((abstract new (...args: any[]) => {
    ...
    start(): Promise<void>;
    stop(): Promise<void>;
    state: import("state-switch").StateSwitchInterface;
    __serviceCtlResettingIndicator: import("state-switch").BusyIndicator;
    __serviceCtlLogger: import("brolog").Logger;
    reset(): Promise<void>;
...
type ProtectedPropertyServiceMixin = '__counter' | '__watchdog' | '__serviceCtlResettingIndicator' | '__serviceCtlLogger';
