...
declare const sayableMixin: <MixinBase extends typeof PuppetSkeleton & (abstract new (...args: any[]) => {
    ...
    messageFile(messageId: string): Promise<import("file-box").FileBoxInterface>;
    messageImage(messageId: string, imageType: import("../schemas/image.js").ImageType): Promise<import("file-box").FileBoxInterface>;
    ...
    messageSendFile(conversationId: string, file: import("file-box").FileBoxInterface): Promise<string | void>;
