...
export const listMessagesOfSpecificTopic = async (botWxid, convId, topic) => {
    ...
    if (!firstUserSetCommand)
        throw new Error("no lastUserSetCommand");
    ...
    if (!nextUserSetCommand)
        throw new Error("no nextUserSetCommand");
