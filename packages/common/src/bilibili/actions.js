...
export const getBilibiliSummary = async (bvid) => {
 ...
 */
export const fetchBvidFromb23tv = async (url) => {
...
export const fetchBilibiliDetail = async (bvid) => {
    ...
    const { data: resData } = await api.get(url, {
        headers: {
            Cookie: "SESSDATA=e4af78fd%2C1726891541%2C3bae6%2A32CjD_F64Z3XX4qdJKQGL2z8q63OzAqcVkS15xyt_roEp3gF1_3jVXkGxGrjYyBiOTZlISVjlodklKckE5TlIzYmZZNHJsSWY1clZsLUxKcWJCMVJCV3RuWnhndWV2RVRfNVlJamZka1V0SmdZYTc4M1phd3VlYWJka0NncnFXZGRDVlhySVN4cjdnIIEC",
        },
    });
    ...
    console.log("-- got bilibili detail");
