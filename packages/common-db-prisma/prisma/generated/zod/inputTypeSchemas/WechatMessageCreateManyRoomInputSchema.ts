...
export const WechatMessageCreateManyRoomInputSchema: z.ZodType<Prisma.WechatMessageCreateManyRoomInput> = z.object({
  id: z.string(),
...
export default WechatMessageCreateManyRoomInputSchema;
