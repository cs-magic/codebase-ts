...
export const WechatMessageCreateManyInputSchema: z.ZodType<Prisma.WechatMessageCreateManyInput> = z.object({
  id: z.string(),
...
export default WechatMessageCreateManyInputSchema;
