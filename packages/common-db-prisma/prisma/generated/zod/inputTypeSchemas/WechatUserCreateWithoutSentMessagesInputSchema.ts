...
export const WechatUserCreateWithoutSentMessagesInputSchema: z.ZodType<Prisma.WechatUserCreateWithoutSentMessagesInput> = z.object({
  id: z.string(),
...
export default WechatUserCreateWithoutSentMessagesInputSchema;
