...
export const WechatUserUncheckedCreateInputSchema: z.ZodType<Prisma.WechatUserUncheckedCreateInput> = z.object({
  id: z.string(),
...
export default WechatUserUncheckedCreateInputSchema;
