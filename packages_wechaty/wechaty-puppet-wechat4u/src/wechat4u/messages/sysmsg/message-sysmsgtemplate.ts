...
import type { Runner } from "src/wechat4u/utils/runner"
...
export async function parseSysmsgTemplateMessagePayload(
  sysmsgTemplateXml: SysmsgTemplateXmlSchema,
): Promise<SysmsgTemplateMessagePayload> {
