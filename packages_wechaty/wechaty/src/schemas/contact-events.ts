...
import type { ContactInterface, FriendshipInterface, MessageInterface } from "src/user-modules/mod"

type ContactEventListenerMessage = (
...
const ContactEventEmitter = EventEmitter as any as new () => TypedEventEmitter<ContactEventListeners>
