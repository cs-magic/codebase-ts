import { GError, TimeoutPromiseGError, timeoutPromise } from "gerror"
...
import type { ContactImpl, ContactInterface, RoomImpl } from "src/user-modules/mod"

import type { GErrorMixin } from "src/wechaty-mixins/gerror-mixin"
import type { IoMixin } from "src/wechaty-mixins/io-mixin"
import type { WechatifyUserModuleMixin } from "src/wechaty-mixins/wechatify-user-module-mixin"
  ...
  abstract class PuppetMixin extends mixinBase {
    ...
    override async init(): Promise<void> {
      ...
      const puppetInstance = await PUPPET.helpers.resolvePuppet({
        ...
        puppetOptions: "puppetOptions" in this.__options ? this.__options.puppetOptions : undefined,
      })
    ...
    __setupPuppetEvents(puppet: PUPPET.impls.PuppetInterface): void {
      ...
      const eventNameList: PUPPET.types.PuppetEventName[] = Object.keys(
        PUPPET.types.PUPPET_EVENT_DICT,
...
type ProtectedPropertyPuppetMixin = "__puppet" | "__readyState" | "__setupPuppetEvents"
