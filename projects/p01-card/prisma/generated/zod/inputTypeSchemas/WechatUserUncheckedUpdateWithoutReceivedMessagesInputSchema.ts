...
import { WechatMessageUncheckedUpdateManyWithoutTalkerNestedInputSchema } from './WechatMessageUncheckedUpdateManyWithoutTalkerNestedInputSchema';
import { TaskUncheckedUpdateManyWithoutOwnerNestedInputSchema } from './TaskUncheckedUpdateManyWithoutOwnerNestedInputSchema';

export const WechatUserUncheckedUpdateWithoutReceivedMessagesInputSchema: z.ZodType<Prisma.WechatUserUncheckedUpdateWithoutReceivedMessagesInput> = z.object({
  ...
  sentMessages: z.lazy(() => WechatMessageUncheckedUpdateManyWithoutTalkerNestedInputSchema).optional(),
  tasks: z.lazy(() => TaskUncheckedUpdateManyWithoutOwnerNestedInputSchema).optional()
}).strict();

export default WechatUserUncheckedUpdateWithoutReceivedMessagesInputSchema;
