...
export const WechatMessageUpdateArgsSchema: z.ZodType<Prisma.WechatMessageUpdateArgs> = z.object({
  select: WechatMessageSelectSchema.optional(),
  include: WechatMessageIncludeSchema.optional(),
  data: z.union([ WechatMessageUpdateInputSchema,WechatMessageUncheckedUpdateInputSchema ]),
  where: WechatMessageWhereUniqueInputSchema,
}).strict() ;

export default WechatMessageUpdateArgsSchema;
