...
export const WechatUserCreateArgsSchema: z.ZodType<Prisma.WechatUserCreateArgs> = z.object({
  select: WechatUserSelectSchema.optional(),
  include: WechatUserIncludeSchema.optional(),
  data: z.union([ WechatUserCreateInputSchema,WechatUserUncheckedCreateInputSchema ]),
}).strict() ;

export default WechatUserCreateArgsSchema;
