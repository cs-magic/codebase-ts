const inferStringGeneric1 = <T extends string | number | boolean | object>(
  v: T,
) => {
  return (s: T) => {
    console.log({ s });
...
// ok
inferStringGeneric1({ hello: "world" })({ hello: "bar" });
