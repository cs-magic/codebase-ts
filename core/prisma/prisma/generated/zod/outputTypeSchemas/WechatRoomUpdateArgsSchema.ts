...
export const WechatRoomUpdateArgsSchema: z.ZodType<Prisma.WechatRoomUpdateArgs> = z.object({
  select: WechatRoomSelectSchema.optional(),
  include: WechatRoomIncludeSchema.optional(),
  data: z.union([ WechatRoomUpdateInputSchema,WechatRoomUncheckedUpdateInputSchema ]),
  where: WechatRoomWhereUniqueInputSchema,
}).strict() ;

export default WechatRoomUpdateArgsSchema;
