...
export const WechatRoomFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WechatRoomFindUniqueOrThrowArgs> = z.object({
  select: WechatRoomSelectSchema.optional(),
  include: WechatRoomIncludeSchema.optional(),
  where: WechatRoomWhereUniqueInputSchema,
}).strict() ;

export default WechatRoomFindUniqueOrThrowArgsSchema;
