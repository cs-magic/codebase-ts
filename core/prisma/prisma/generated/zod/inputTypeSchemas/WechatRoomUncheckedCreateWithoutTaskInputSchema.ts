...
export const WechatRoomUncheckedCreateWithoutTaskInputSchema: z.ZodType<Prisma.WechatRoomUncheckedCreateWithoutTaskInput> = z.object({
  id: z.string(),
...
export default WechatRoomUncheckedCreateWithoutTaskInputSchema;
