...
export const WechatMessageCreateManyTalkerInputSchema: z.ZodType<Prisma.WechatMessageCreateManyTalkerInput> = z.object({
  id: z.string(),
...
export default WechatMessageCreateManyTalkerInputSchema;
