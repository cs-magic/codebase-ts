...
import { WechatUserCreateInputSchema } from '../inputTypeSchemas/WechatUserCreateInputSchema'
import { WechatUserUncheckedCreateInputSchema } from '../inputTypeSchemas/WechatUserUncheckedCreateInputSchema'
...
export const WechatUserUpsertArgsSchema: z.ZodType<Prisma.WechatUserUpsertArgs> = z.object({
  select: WechatUserSelectSchema.optional(),
  include: WechatUserIncludeSchema.optional(),
  where: WechatUserWhereUniqueInputSchema,
  create: z.union([ WechatUserCreateInputSchema,WechatUserUncheckedCreateInputSchema ]),
  update: z.union([ WechatUserUpdateInputSchema,WechatUserUncheckedUpdateInputSchema ]),
}).strict() ;

export default WechatUserUpsertArgsSchema;
