  ...
  <SectionWrapper>
    <div className="custom-screen">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl font-semibold sm:text-4xl" id="oss">
          TotemGPT is Proudly Open Source
        </h2>
        <p className="mt-3">Our source code is available on GitHub.</p>
        <a
          href="https://github.com/cs-magic/totem-gpt-web"
